  ...
  return (
    <div className="wrapped">
      <header className="site-header">
        <Navbar className={`is-transparent ${montserrat.className}`} collapseOnSelect variant="dark" expand="lg">
          <Container>
            <Navbar.Brand>
      ...
      <div className="section footer-section footer-particle section-pad-sm section-bg-dark ">
        <Container>
          <Row>
            ...
            <div id="block-6" className={`widget footer-widget widget_block widget_text ${montserrat.className}`} style={{display: 'block', fontSize: 14}}>
            ...
            <div id="nav_menu-3" className="widget footer-widget widget_nav_menu">
              ...
              <div className="menu-futer-menyu-2-container">
                <Nav id="menu-futer-menyu-2" className={`menu ${montserrat.className}`} style={{display: 'block', fontSize: 14}}>
            ...
            <div id="nav_menu-3" className="widget footer-widget widget_nav_menu">
              ...
              <div className="menu-futer-menyu-container">
                <Nav id="menu-futer-menyu" className={`menu ${montserrat.className}`} style={{display: 'block', fontSize: 14}}>
            ...
            <div id="nav_menu-4" className="widget footer-widget widget_nav_menu">
              ...
              <div className="menu-informacziya-container">
                <Nav id="menu-informacziya" className={`menu ${montserrat.className}`} style={{display: 'block', fontSize: 14}}>
      ...
      <footer className="section footer-section section-pad-nopd section-bg ">
        <Container>
          <Row className="text-center">
            <Col md={12}> <span className={`copyright-text ${montserrat.className}`}> Copyright © 2022 by <a href="/">HareCrypta</a></span> </Col>
          </Row>
        </Container>
      </footer>
    </div>
